...
- Promote pipeline selected to Default Pipelines on save when creating or editing Helm boards.
- Rollback status not updated in the UI after successful completion (CR-13610) 
