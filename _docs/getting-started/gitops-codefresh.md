...
Review [GitOps runtime architecture]({{site.baseurl}}/docs/gitops-runtime/runtime-architecture/).  
For installation, see [Hosted GitOps setup]({{site.baseurl}}/docs/gitops-runtime/hosted-runtime/) and [Hybrid GitOps installation]({{site.baseurl}}/docs/installation/gitops/hybrid-gitops/).
