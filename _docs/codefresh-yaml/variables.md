...
| {% raw %}`${{CF_KUBECONFIG_PATH}}`{% endraw %}    | Path to kubeconfig if at least one Kubernetes cluster [is configured]({{site.baseurl}}/docs/deploy-to-kubernetes/add-kubernetes-cluster/)                                                                                                                                                                                                                                                                       |
