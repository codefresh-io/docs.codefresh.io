...
| `cache_enabled`                                 | Enable Docker layer cache to reuse unchanged image layers and reduce build time. To enable, set field to <code>true</code>. [more info](https://codefresh.io/docs/docs/troubleshooting/common-issues/disabling-codefresh-caching-mechanisms/) | Optional
