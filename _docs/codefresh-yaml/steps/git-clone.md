...
| `repo`                                     | The path of the repository without the domain name in the form of `my_username/ my_repo`. To clone a GitHub wiki, specidy the complete URL of the wiki, including the protocol prefix, for example, `"https://github.com/wikis/examples.wiki"`.                                                          | Required                  |
