...
| `git` | The name of the [git integration]({{site.baseurl}}/docs/integrations/git-providers/) you want to use. You can also use `CF-default` as a value (or leave it empty) for the default git provider that was used during Codefresh sign-up| Required| 
