...
Read more on [GitOps Runtime]({{site.baseurl}}/docs/installation/gitops/gitops/) and [GitOps Runtime Architecture]({{site.baseurl}}/docs/installation/gitops/gitops-runtime/runtime-architecture/).
