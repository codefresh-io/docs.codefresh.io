...
where:  
  ...
  * `<namespace>` is the namespace in which to install the Hybrid GitOps runtime, and is either the default `codefresh`, or any custom name you define.
  ...
  * `<runtime-name>` is the name of the runtime, either the default `codefresh`, or a custom name you define. 
