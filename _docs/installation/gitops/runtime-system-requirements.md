...
|Egress for air-gapped clusters |{::nomarkdown}<ul><li>Codefresh platform: HTTPS egress to platform through <a href="https://codefresh.io/docs/docs/gitops/administration/platform-ip-addresses/#platform-ip">sallowed list of IP addresses</a></li><li>Repository access: Egress to Git, Helm, OCI repos accessed by Argo CD via HTTP, HTTPS, or SSH, as appropriate</li></ul>{:/}|
