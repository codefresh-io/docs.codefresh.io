...
When a Runtime is designated as a Configuration Runtime, Codefresh creates a folder entitled `configuration` within `resources` in the Shared Configuration Repository. The folder includes additional subfolders for the different platform settings.
