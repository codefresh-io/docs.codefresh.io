...
### Set up the Restricted Git Source
...
* Deployment destinations  
  You can define the  synced to a Restricted Git Source can be deployed to destination clusters and namespaces defined by the Restricted Git Source.
