...
##### When is it created? 
The Shared Configuration Repository (internally ISO/iso) is created on installing a Hosted or Hybrid GitOps Runtime. See [GitOps Runtimes & Shared Configuration Repos](#gitops-runtimes--shared-configuration-repos).
...
### Shared Configuration Repo URL formats for Hybrid Runtimes 
When defining the Shared Configuration Repository for Hybrid GitOps Runtimes, you have the option to specify a path, a branch, or both within the repository URL.
