...
| `CF_GERRIT_USERNAME`              | Relevant only for Gerrit accounts. <br> The username of your Gerrit account.| Required  |
| `CF_GERRIT_PASSWORD`              | Relevant only for Gerrit accounts. <br> The HTTP password you generated to use as the access token to authenticate HTTP requests to Gerrit. | Required  |
