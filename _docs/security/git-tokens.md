...
| ---------------------------- | ------------------------------ | 
| GitHub and GitHub Enterprise |{::nomarkdown}<ul><li>Classic:<ul><li><code class="highlighter-rouge">repo</code></li><li><code class="highlighter-rouge">admin:repo_hook</code></li></ul><li>Fine-grained:<ul><li>Repository access: <code class="highlighter-rouge">All repositories</code> or <code class="highlighter-rouge">Only select repositories</code></li><li>Repository permissions:<ul><li>Administration: <code class="highlighter-rouge">Read and write</code></li><li>Contents: <code class="highlighter-rouge">Read and write</code></li><li>Metadata: <code class="highlighter-rouge">Read-only</code></li><li>Webhook: <code class="highlighter-rouge">Read and write</code></li></ul></li></ul></li><li>Fine-grained group: Must have <code class="highlighter-rouge">write</code> access to the <a href="https://codefresh.io/docs/docs/installation/gitops/shared-configuration/">Shared Configuration Repository</a>, and <code class="highlighter-rouge">read</code> access to the all the repositories that Argo CD syncs from.</ul>{:/}|
| GitLab Cloud and GitLab Server       |{::nomarkdown}<ul><li>Individual: <code class="highlighter-rouge">api</code> (includes <code class="highlighter-rouge">read_api</code>, <code class="highlighter-rouge">read_repository</code>, and <code class="highlighter-rouge">write_repository</code>)</li><li>Group: <code class="highlighter-rouge">write</code> access to the [Shared Configuration Repository](), and <code class="highlighter-rouge">read</code> access to the all the repositories that Argo CD syncs from.</ul> {:/}         |             
