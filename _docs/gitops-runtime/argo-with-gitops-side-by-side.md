...
redirect_from:
  - /docs/gitops-runtime/argo-with-gitops-side-by-side/
toc: true
---
...
Before you begin installation, review [Additional installation flags for GitOps Runtime with Community Argo CD](#additional-installation-flags-for-hybrid-gitops-runtime-with-community-argo-cd), and then follow our [step-by-step installation guide]({{site.baseurl}}/docs/gitops-runtime/hybrid-gitops-helm-installation/#install-first-gitops-runtime-in-account) to install the Hybrid GitOps Runtime via Helm.  
...
* Add a [Git Source]({{site.baseurl}}/docs/gitops-runtime/git-sources/#create-a-git-source) to your GitOps Runtime.
