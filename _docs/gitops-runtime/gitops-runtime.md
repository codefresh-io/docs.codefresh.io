...
### Core capabilities and benefits of the GitOps Runtime
...
Before you install a GitOps Runtime, review:
* Insights into unique concepts and components you'll come across during installation in [Runtime concepts]({{site.baseurl}}/docs/gitops-runtime/runtime-concepts/).
* Verify readiness for a smooth and successful installation by reviewing [System requirements and prerequisites]({{site.baseurl}}/docs/gitops-runtime/runtime-system-requirements/).
...
* **Clean-cluster installation without Argo CD**  
  ...
  See [Install GitOps Runtime]({{site.baseurl}}/docs/gitops-runtime/hybrid-gitops-helm-installation/).
...
* **Cluster installation with Community Argo CD**
  ...
  See [Install GitOps Runtime alongside Community Argo CD]({{site.baseurl}}/docs/gitops-runtime/argo-with-gitops-side-by-side/).

## Number of GitOps Runtimes in account
...
See [Installing additional GitOps Runtimes from the Codefresh UI]({{site.baseurl}}/docs/gitops-runtime/hybrid-gitops-helm-installation#install-additional-gitops-runtimes-in-account), or using [Terraform]({{site.baseurl}}/docs/gitops-runtime/hybrid-gitops-helm-installation/install-gitops-runtime-via-terraform).
...
For the architecture, see [Hosted GitOps Runtime architecture]({{site.baseurl}}/docs/gitops-runtime/runtime-architecture/).
...
%} 
  ...
  For more information on how to set up the hosted environment, including provisioning hosted runtimes, see [Set up Hosted GitOps]({{site.baseurl}}/docs/gitops-runtime/hosted-runtime/).  
