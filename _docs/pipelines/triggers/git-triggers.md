...
* *More Options* 
  ...
  * *Report notification on pipeline execution* - Decide if [Slack notifications]({{site.baseurl}}/docs/integrations/notifications/slack-intergration/) will be sent (as well as status updates back to your Git provider)
