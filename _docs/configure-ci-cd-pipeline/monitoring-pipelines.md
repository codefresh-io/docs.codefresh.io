...
A variable with a strikethrough indicates an override at a lower-level. For rules on precedence and overrides for variables in builds, see [Variables]({{site.baseurl}}/docs/codefresh-yaml/variables/).  
