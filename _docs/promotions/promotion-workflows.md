...
Whichever method you use to create your Promotion Workflow, make sure you include the annotation to classify and use it as a Promotion Workflow in the manifest.
