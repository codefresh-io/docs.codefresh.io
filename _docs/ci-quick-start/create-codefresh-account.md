...
Begin your CI journey by creating an account in Codefresh.
...
1. Select the use cases for your organization and account from among those displayed.  
  In this case, you'll select **Continuous Integration with GitOps**  **Continuous Delivery with Pipelines** and then click **Finish**. 
