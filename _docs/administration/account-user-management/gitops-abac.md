...
| --------------         | --------------           |  
|**Entity**                  | The entity for which to add the rule, and can be one of the following: {::nomarkdown} <ul><li>GitOps Applications</li><li>Promotion Flows</li><li>Products</li><li>Environments</li></ul>{:/}|
