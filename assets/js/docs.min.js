 ...
 * Licensed MIT
 */
!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):e("object"==typeof module&&module.exports?require("jquery"):jQuery)}(function(m){var f={},e={exclude:[],excludeWithin:[],offset:0,direction:"top",delegateSelector:null,scrollElement:null,scrollTarget:null,autoFocus:!1,beforeScroll:function(){},afterScroll:function(){},easing:"swing",speed:400,autoCoefficient:2,preventDefault:!0},n=function(e){var t=[],n=!1,r=e.dir&&"left"===e.dir?"scrollLeft":"scrollTop";return this.each(function(){var e=m(this);if(this!==document&&this!==window)return!document.scrollingElement||this!==document.documentElement&&this!==document.body?void(e[r]()>0?t.push(this):(e[r](1),n=e[r]()>0,n&&t.push(this),e[r](0))):(t.push(document.scrollingElement),!1)}),t.length||this.each(function(){this===document.documentElement&&"smooth"===m(this).css("scrollBehavior")&&(t=[this]),t.length||"BODY"!==this.nodeName||(t=[this])}),"first"===e.el&&t.length>1&&(t=[t[0]]),t},r=/^([\-\+]=)(\d+)/;m.fn.extend({scrollable:function(e){var t=n.call(this,{dir:e});return this.pushStack(t)},firstScrollable:function(e){var t=n.call(this,{el:"first",dir:e});return this.pushStack(t)},smoothScroll:function(e,n){if("options"===(e=e||{}))return n?this.each(function(){var e=m(this),t=m.extend(e.data("ssOpts")||{},n);m(this).data("ssOpts",t)}):this.first().data("ssOpts");var g=m.extend({},m.fn.smoothScroll.defaults,e),t=function(e){var t=function(e){return e.replace(/(:|\.|\/)/g,"\\$1")},n=this,r=m(this),i=m.extend({},g,r.data("ssOpts")||{}),o=g.exclude,a=i.excludeWithin,s=0,l=0,c=!0,u={},h=m.smoothScroll.filterPath(location.pathname),d=m.smoothScroll.filterPath(n.pathname),f=location.hostname===n.hostname||!n.hostname,p=i.scrollTarget||d===h,A=t(n.hash);if(A&&!m(A).length&&(c=!1),i.scrollTarget||f&&p&&A){for(;c&&s<o.length;)r.is(t(o[s++]))&&(c=!1);for(;c&&l<a.length;)r.closest(a[l++]).length&&(c=!1)}else c=!1;c&&(i.preventDefault&&e.preventDefault(),m.extend(u,i,{scrollTarget:i.scrollTarget||A,link:n}),m.smoothScroll(u))};return null!==e.delegateSelector?this.off("click.smoothscroll",e.delegateSelector).on("click.smoothscroll",e.delegateSelector,t):this.off("click.smoothscroll").on("click.smoothscroll",t),this}});var p=function(e){var t={relative:""},n="string"==typeof e&&r.exec(e);return"number"==typeof e?t.px=e:n&&(t.relative=n[1],t.px=parseFloat(n[2])||0),t},A=function(e){var t=m(e.scrollTarget);e.autoFocus&&t.length&&(t[0].focus(),t.is(document.activeElement)||(t.prop({tabIndex:-1}),t[0].focus())),e.afterScroll.call(e.link,e)};m.smoothScroll=function(e,t){if("options"===e&&"object"==typeof t)return m.extend(f,t);var n,r,i,o,a=p(e),s={},l=0,c="offset",u="scrollTop",h={},d={};a.px?n=m.extend({link:null},m.fn.smoothScroll.defaults,f):(n=m.extend({link:null},m.fn.smoothScroll.defaults,e||{},f),n.scrollElement&&(c="position","static"===n.scrollElement.css("position")&&n.scrollElement.css("position","relative")),t&&(a=p(t))),u="left"===n.direction?"scrollLeft":u,n.scrollElement?(r=n.scrollElement,a.px||/^(?:HTML|BODY)$/.test(r[0].nodeName)||(l=r[u]())):r=m("html, body").firstScrollable(n.direction),n.beforeScroll.call(r,n),s=a.px?a:{relative:"",px:m(n.scrollTarget)[c]()&&m(n.scrollTarget)[c]()[n.direction]||0},h[u]=s.relative+(s.px+l+n.offset),i=n.speed,"auto"===i&&(o=Math.abs(h[u]-r[u]()),i=o/n.autoCoefficient),d={duration:i,easing:n.easing,complete:function(){A(n)}},n.step&&(d.step=n.step),r.length?r.stop().animate(h,d):A(n)},m.smoothScroll.version="2.2.0",m.smoothScroll.filterPath=function(e){return e=e||"",e.replace(/^\//,"").replace(/(?:index|default).[a-zA-Z]{3,4}$/,"").replace(/\/$/,"")},m.fn.smoothScroll.defaults=e});(function(e){var t;if(typeof define==="function"&&define.amd){define(e);t=true}if(typeof exports==="object"){module.exports=e();t=true}if(!t){var n=window.Cookies;var r=window.Cookies=e();r.noConflict=function(){window.Cookies=n;return r}}})(function(){function s(){var e=0;var t={};for(;e<arguments.length;e++){var n=arguments[e];for(var r in n){t[r]=n[r]}}return t}function c(e){return e.replace(/(%[0-9A-Z]{2})+/g,decodeURIComponent)}function e(l){function a(){}function n(e,t,n){if(typeof document==="undefined"){return}n=s({path:"/"},a.defaults,n);if(typeof n.expires==="number"){n.expires=new Date(new Date*1+n.expires*864e5)}n.expires=n.expires?n.expires.toUTCString():"";try{var r=JSON.stringify(t);if(/^[\{\[]/.test(r)){t=r}}catch(e){}t=l.write?l.write(t,e):encodeURIComponent(String(t)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent);e=encodeURIComponent(String(e)).replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent).replace(/[\(\)]/g,escape);var i="";for(var o in n){if(!n[o]){continue}i+="; "+o;if(n[o]===true){continue}i+="="+n[o].split(";")[0]}return document.cookie=e+"="+t+i}function t(e,t){if(typeof document==="undefined"){return}var n={};var r=document.cookie?document.cookie.split("; "):[];var i=0;for(;i<r.length;i++){var o=r[i].split("=");var a=o.slice(1).join("=");if(!t&&a.charAt(0)==='"'){a=a.slice(1,-1)}try{var s=c(o[0]);a=(l.read||l)(a,s)||c(a);if(t){try{a=JSON.parse(a)}catch(e){}}n[s]=a;if(e===s){break}}catch(e){}}return e?n[e]:n}a.set=n;a.get=function(e){return t(e,false)};a.getJSON=function(e){return t(e,true)};a.remove=function(e,t){n(e,"",s(t,{expires:-1}))};a.defaults={};a.withConverter=e;return a}return e(function(){})});(function(i){"use strict";i(function(){i(".tooltip-demo").tooltip({selector:'[data-toggle="tooltip"]',container:"body"});i(document).on("click",'[data-toggle="lightbox"]',function(e){e.preventDefault();i(this).ekkoLightbox()});i('[data-toggle="popover"]').popover();i(".tooltip-test").tooltip();i(".popover-test").popover();i('.bd-example-indeterminate [type="checkbox"]').prop("indeterminate",true);i('.bd-content [href="#"]').click(function(e){e.preventDefault()});i("#exampleModal").on("show.bs.modal",function(e){var t=i(e.relatedTarget);var n=t.data("whatever");var r=i(this);r.find(".modal-title").text("New message to "+n);r.find(".modal-body input").val(n)});i(".bd-toggle-animated-progress").on("click",function(){i(this).siblings(".progress").find(".progress-bar-striped").toggleClass("progress-bar-animated")});i("figure.highlight, div.highlight").each(function(){var e='<div class="bd-clipboard"><button class="btn-clipboard" title="Copy to clipboard">Copy</button></div>';i(this).before(e);i(".btn-clipboard").tooltip().on("mouseleave",function(){i(this).tooltip("hide")})});var e=new Clipboard(".btn-clipboard",{target:function(e){return e.parentNode.nextElementSibling}});e.on("success",function(e){i(e.trigger).attr("title","Copied!").tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle");e.clearSelection()});e.on("error",function(e){var t=/Mac/i.test(navigator.userAgent)?"⌘":"Ctrl-";var n="Press "+t+"C to copy";i(e.trigger).attr("title",n).tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle")});i("#bd-docs-nav").on("click","a",function(){window.localStorage.setItem("scrollto",i(this).offset().top)});if(i("#bd-docs-nav li.active").length>0){i("#bd-docs-nav").animate({scrollTop:i("#bd-docs-nav").scrollTop()+(i("#bd-docs-nav li.active").last().offset().top-(window.localStorage.getItem("scrollto")||i("#bd-docs-nav").height()/2))},{duration:0,easing:"linear",complete:function(){window.localStorage.removeItem("scrollto")}})}anchors.options={icon:"#"};anchors.add(".bd-content-inner > h2, .bd-content-inner > h3, .bd-content-inner > h4, .bd-content-inner > h5");i(".bd-content-inner > h2, .bd-content-inner > h3, .bd-content-inner > h4, .bd-content-inner > h5").wrapInner("<div></div>");i("a").smoothScroll({offset:0});i(".section-nav").on("click","a",function(){window.location.hash=i(this).attr("href");return false});if(window.docsearch){var t=window.docsearch({apiKey:"3d145052b8422fa173d681e9a761f81e",indexName:"codefresh",inputSelector:".doc-search-input",handleSelected:function(e,t,n){var r=n.url;r=n.isLvl1?r.split("#")[0]:r;window.location.href=r},algoliaOptions:{hitsPerPage:6},transformData:function(e){return e.map(function(e){if(location.href.match(/(192.168|127.0.|localhost).*:19001/)){e.url=e.url.replace("https://vmechkauskas-codefresh.github.io/","/")}return e})},debug:false});t.autocomplete.on("autocomplete:opened",function(e){});var n={getUrlParameter:function e(t){t=t.replace(/[[]/,"\\[").replace(/[\]]/,"\\]");var n=new RegExp("[\\?&]"+t+"=([^&#]*)");var r=n.exec(location.search);return r===null?"":decodeURIComponent(r[1].replace(/\+/g," "))},triggerSearch:function e(t){var n=this.getUrlParameter("q");if(n.length>0&&t&&t.input){var r=i(t.input[0]);r.focus().trigger("input").trigger("keypress");t.input.autocomplete.setVal(n);setTimeout(function(){t.input.autocomplete.open()},500)}}};n.triggerSearch(t)}Holder.addTheme("gray",{bg:"#777",fg:"rgba(255,255,255,.75)",font:"Helvetica",fontweight:"normal"});function r(e){var t=i(".docs-layout");if(e){t.removeClass("container").addClass("container-fluid")}else{t.removeClass("container-fluid").addClass("container")}}i("#layoutModeSwitcher").on("change",function(){var e=this.checked?"1":"0";r(this.checked);window.Cookies.set("layoutMode",e);i(this).next().html(this.checked?"Wide layout":"Boxed layout")}).each(function(){var e=window.Cookies.get("layoutMode");if(e===undefined){var t=i(".docs-layout").data("layout-mode");if(t==="wide"){r(true);i(this).prop("checked",true);i(this).next().html("Wide layout")}else if(t==="boxed"){r(false);i(this).prop("checked",false);i(this).next().html("Boxed layout")}}else if(Number(e)===1){i(this).prop("checked",true);r(true);i(this).next().html("Wide layout")}else if(Number(e)===0){i(this).prop("checked",false);r(false);i(this).next().html("Boxed layout")}})})})(jQuery);(function(){"use strict";function e(){var e=/MSIE ([0-9.]+)/.exec(window.navigator.userAgent);if(e===null){return null}var t=parseInt(e[1],10);var n=Math.floor(t);return n}function t(){var e=new Function("/*@cc_on return @_jscript_version; @*/")();if(typeof e==="undefined"){return 11}if(e<9){return 8}return e}var n=window.navigator.userAgent;if(n.indexOf("Opera")>-1||n.indexOf("Presto")>-1){return}var r=e();if(r===null){return}var i=t();if(r!==i){window.alert("WARNING: You appear to be using IE"+i+" in IE"+r+" emulation mode.\nIE emulation modes can behave significantly differently from ACTUAL older versions of IE.\nPLEASE DON'T FILE BOOTSTRAP BUGS based on testing in IE emulation modes!")}})();(function(){"use strict";if("serviceWorker"in navigator){window.addEventListener("load",function(){navigator.serviceWorker.register("/sw.js").then(function(e){console.log("ServiceWorker registration successful with scope: ",e.scope)}).catch(function(e){console.log("ServiceWorker registration failed: ",e)})})}else{console.log("Service workers are not supported.")}})();