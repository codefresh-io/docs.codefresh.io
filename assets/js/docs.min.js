 ...
 * Licensed MIT
 */
!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):e("object"==typeof module&&module.exports?require("jquery"):jQuery)}(function(e){var t={},n={exclude:[],excludeWithin:[],offset:0,direction:"top",delegateSelector:null,scrollElement:null,scrollTarget:null,autoFocus:!1,beforeScroll:function(){},afterScroll:function(){},easing:"swing",speed:400,autoCoefficient:2,preventDefault:!0},r=function(t){var n=[],r=!1,i=t.dir&&"left"===t.dir?"scrollLeft":"scrollTop";return this.each(function(){var t=e(this);if(this!==document&&this!==window)return!document.scrollingElement||this!==document.documentElement&&this!==document.body?void(t[i]()>0?n.push(this):(t[i](1),r=t[i]()>0,r&&n.push(this),t[i](0))):(n.push(document.scrollingElement),!1)}),n.length||this.each(function(){this===document.documentElement&&"smooth"===e(this).css("scrollBehavior")&&(n=[this]),n.length||"BODY"!==this.nodeName||(n=[this])}),"first"===t.el&&n.length>1&&(n=[n[0]]),n},i=/^([\-\+]=)(\d+)/;e.fn.extend({scrollable:function(e){var t=r.call(this,{dir:e});return this.pushStack(t)},firstScrollable:function(e){var t=r.call(this,{el:"first",dir:e});return this.pushStack(t)},smoothScroll:function(t,n){if("options"===(t=t||{}))return n?this.each(function(){var t=e(this),r=e.extend(t.data("ssOpts")||{},n);e(this).data("ssOpts",r)}):this.first().data("ssOpts");var r=e.extend({},e.fn.smoothScroll.defaults,t),i=function(t){var n=function(e){return e.replace(/(:|\.|\/)/g,"\\$1")},i=this,o=e(this),a=e.extend({},r,o.data("ssOpts")||{}),s=r.exclude,l=a.excludeWithin,c=0,u=0,h=!0,d={},f=e.smoothScroll.filterPath(location.pathname),p=e.smoothScroll.filterPath(i.pathname),A=location.hostname===i.hostname||!i.hostname,g=a.scrollTarget||p===f,m=n(i.hash);if(m&&!e(m).length&&(h=!1),a.scrollTarget||A&&g&&m){for(;h&&c<s.length;)o.is(n(s[c++]))&&(h=!1);for(;h&&u<l.length;)o.closest(l[u++]).length&&(h=!1)}else h=!1;h&&(a.preventDefault&&t.preventDefault(),e.extend(d,a,{scrollTarget:a.scrollTarget||m,link:i}),e.smoothScroll(d))};return null!==t.delegateSelector?this.off("click.smoothscroll",t.delegateSelector).on("click.smoothscroll",t.delegateSelector,i):this.off("click.smoothscroll").on("click.smoothscroll",i),this}});var o=function(e){var t={relative:""},n="string"==typeof e&&i.exec(e);return"number"==typeof e?t.px=e:n&&(t.relative=n[1],t.px=parseFloat(n[2])||0),t},a=function(t){var n=e(t.scrollTarget);t.autoFocus&&n.length&&(n[0].focus(),n.is(document.activeElement)||(n.prop({tabIndex:-1}),n[0].focus())),t.afterScroll.call(t.link,t)};e.smoothScroll=function(n,r){if("options"===n&&"object"==typeof r)return e.extend(t,r);var i,s,l,c,u=o(n),h={},d=0,f="offset",p="scrollTop",A={},g={};u.px?i=e.extend({link:null},e.fn.smoothScroll.defaults,t):(i=e.extend({link:null},e.fn.smoothScroll.defaults,n||{},t),i.scrollElement&&(f="position","static"===i.scrollElement.css("position")&&i.scrollElement.css("position","relative")),r&&(u=o(r))),p="left"===i.direction?"scrollLeft":p,i.scrollElement?(s=i.scrollElement,u.px||/^(?:HTML|BODY)$/.test(s[0].nodeName)||(d=s[p]())):s=e("html, body").firstScrollable(i.direction),i.beforeScroll.call(s,i),h=u.px?u:{relative:"",px:e(i.scrollTarget)[f]()&&e(i.scrollTarget)[f]()[i.direction]||0},A[p]=h.relative+(h.px+d+i.offset),l=i.speed,"auto"===l&&(c=Math.abs(A[p]-s[p]()),l=c/i.autoCoefficient),g={duration:l,easing:i.easing,complete:function(){a(i)}},i.step&&(g.step=i.step),s.length?s.stop().animate(A,g):a(i)},e.smoothScroll.version="2.2.0",e.smoothScroll.filterPath=function(e){return e=e||"",e.replace(/^\//,"").replace(/(?:index|default).[a-zA-Z]{3,4}$/,"").replace(/\/$/,"")},e.fn.smoothScroll.defaults=n});(function(e){var t;if(typeof define==="function"&&define.amd){define(e);t=true}if(typeof exports==="object"){module.exports=e();t=true}if(!t){var n=window.Cookies;var r=window.Cookies=e();r.noConflict=function(){window.Cookies=n;return r}}})(function(){function e(){var e=0;var t={};for(;e<arguments.length;e++){var n=arguments[e];for(var r in n){t[r]=n[r]}}return t}function t(e){return e.replace(/(%[0-9A-Z]{2})+/g,decodeURIComponent)}function n(r){function i(){}function o(t,n,o){if(typeof document==="undefined"){return}o=e({path:"/"},i.defaults,o);if(typeof o.expires==="number"){o.expires=new Date(new Date*1+o.expires*864e5)}o.expires=o.expires?o.expires.toUTCString():"";try{var a=JSON.stringify(n);if(/^[\{\[]/.test(a)){n=a}}catch(e){}n=r.write?r.write(n,t):encodeURIComponent(String(n)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent);t=encodeURIComponent(String(t)).replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent).replace(/[\(\)]/g,escape);var s="";for(var l in o){if(!o[l]){continue}s+="; "+l;if(o[l]===true){continue}s+="="+o[l].split(";")[0]}return document.cookie=t+"="+n+s}function a(e,n){if(typeof document==="undefined"){return}var i={};var o=document.cookie?document.cookie.split("; "):[];var a=0;for(;a<o.length;a++){var s=o[a].split("=");var l=s.slice(1).join("=");if(!n&&l.charAt(0)==='"'){l=l.slice(1,-1)}try{var c=t(s[0]);l=(r.read||r)(l,c)||t(l);if(n){try{l=JSON.parse(l)}catch(e){}}i[c]=l;if(e===c){break}}catch(e){}}return e?i[e]:i}i.set=o;i.get=function(e){return a(e,false)};i.getJSON=function(e){return a(e,true)};i.remove=function(t,n){o(t,"",e(n,{expires:-1}))};i.defaults={};i.withConverter=n;return i}return n(function(){})});(function(e){"use strict";e(function(){e(".tooltip-demo").tooltip({selector:'[data-toggle="tooltip"]',container:"body"});e(document).on("click",'[data-toggle="lightbox"]',function(t){t.preventDefault();e(this).ekkoLightbox()});e('[data-toggle="popover"]').popover();e(".tooltip-test").tooltip();e(".popover-test").popover();e('.bd-example-indeterminate [type="checkbox"]').prop("indeterminate",true);e('.bd-content [href="#"]').click(function(e){e.preventDefault()});e("#exampleModal").on("show.bs.modal",function(t){var n=e(t.relatedTarget);var r=n.data("whatever");var i=e(this);i.find(".modal-title").text("New message to "+r);i.find(".modal-body input").val(r)});e(".bd-toggle-animated-progress").on("click",function(){e(this).siblings(".progress").find(".progress-bar-striped").toggleClass("progress-bar-animated")});e("figure.highlight, div.highlight").each(function(){var t='<div class="bd-clipboard"><button class="btn-clipboard" title="Copy to clipboard">Copy</button></div>';e(this).before(t);e(".btn-clipboard").tooltip().on("mouseleave",function(){e(this).tooltip("hide")})});var t=new Clipboard(".btn-clipboard",{target:function(e){return e.parentNode.nextElementSibling}});t.on("success",function(t){e(t.trigger).attr("title","Copied!").tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle");t.clearSelection()});t.on("error",function(t){var n=/Mac/i.test(navigator.userAgent)?"⌘":"Ctrl-";var r="Press "+n+"C to copy";e(t.trigger).attr("title",r).tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle")});e("#bd-docs-nav").on("click","a",function(){window.localStorage.setItem("scrollto",e(this).offset().top)});if(e("#bd-docs-nav li.active").length>0){e("#bd-docs-nav").animate({scrollTop:e("#bd-docs-nav").scrollTop()+(e("#bd-docs-nav li.active").last().offset().top-(window.localStorage.getItem("scrollto")||e("#bd-docs-nav").height()/2))},{duration:0,easing:"linear",complete:function(){window.localStorage.removeItem("scrollto")}})}anchors.options={icon:"#"};anchors.add(".bd-content-inner > h2, .bd-content-inner > h3, .bd-content-inner > h4, .bd-content-inner > h5");e(".bd-content-inner > h2, .bd-content-inner > h3, .bd-content-inner > h4, .bd-content-inner > h5").wrapInner("<div></div>");e("a").smoothScroll({offset:0});e(".section-nav").on("click","a",function(){window.location.hash=e(this).attr("href");return false});if(window.docsearch){var n=window.docsearch({apiKey:"3d145052b8422fa173d681e9a761f81e",indexName:"codefresh",inputSelector:".doc-search-input",handleSelected:function(e,t,n){var r=n.url;r=n.isLvl1?r.split("#")[0]:r;window.location.href=r},algoliaOptions:{hitsPerPage:6},transformData:function(e){return e.map(function(e){if(location.href.match(/(192.168|127.0.|localhost).*:19001/)){e.url=e.url.replace("https://vmechkauskas-codefresh.github.io/","/")}return e})},debug:false});n.autocomplete.on("autocomplete:opened",function(e){});var r={getUrlParameter:function e(t){t=t.replace(/[[]/,"\\[").replace(/[\]]/,"\\]");var n=new RegExp("[\\?&]"+t+"=([^&#]*)");var r=n.exec(location.search);return r===null?"":decodeURIComponent(r[1].replace(/\+/g," "))},triggerSearch:function t(n){var r=this.getUrlParameter("q");if(r.length>0&&n&&n.input){var i=e(n.input[0]);i.focus().trigger("input").trigger("keypress");n.input.autocomplete.setVal(r);setTimeout(function(){n.input.autocomplete.open()},500)}}};r.triggerSearch(n)}Holder.addTheme("gray",{bg:"#777",fg:"rgba(255,255,255,.75)",font:"Helvetica",fontweight:"normal"})})})(jQuery);(function(){"use strict";function e(){var e=/MSIE ([0-9.]+)/.exec(window.navigator.userAgent);if(e===null){return null}var t=parseInt(e[1],10);var n=Math.floor(t);return n}function t(){var e=new Function("/*@cc_on return @_jscript_version; @*/")();if(typeof e==="undefined"){return 11}if(e<9){return 8}return e}var n=window.navigator.userAgent;if(n.indexOf("Opera")>-1||n.indexOf("Presto")>-1){return}var r=e();if(r===null){return}var i=t();if(r!==i){window.alert("WARNING: You appear to be using IE"+i+" in IE"+r+" emulation mode.\nIE emulation modes can behave significantly differently from ACTUAL older versions of IE.\nPLEASE DON'T FILE BOOTSTRAP BUGS based on testing in IE emulation modes!")}})();(function(){"use strict";if("serviceWorker"in navigator){window.addEventListener("load",function(){navigator.serviceWorker.register("/sw.js").then(function(e){console.log("ServiceWorker registration successful with scope: ",e.scope)}).catch(function(e){console.log("ServiceWorker registration failed: ",e)})})}else{console.log("Service workers are not supported.")}})();